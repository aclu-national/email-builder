const data = {
  ...
  logo: {
    ...
    newsletter: {
      size: '300',
      url: 'https://media.sailthru.com/64d/1k9/4/m/6807bc82ba382.png'
    },
    ninety: {
      size: '200',
      url: ''
  ...
  signatures: {
    advo: {
      ...
      name: 'Shilpi Agarwal',
      pronouns: '',
      title: 'Director of Legal Policy'
    },
    comms: {
      headshot: 'https://media.sailthru.com/64d/1k4/4/s/5ea8845771af7.jpg',
    ...
    dev: {
      headshot: 'https://media.sailthru.com/64d/1k4/4/s/5ea8846593c8b.png',
      name: 'Cori Stell',
      pronouns: 'She, her, hers',
      title: 'Director of Development'
    },
    ed: {
      headshot: 'https://media.sailthru.com/64d/1k4/3/2/5e5d7579737e4.jpg',
      name: 'Abdi Soltani',
      pronouns: 'He, him, his',
  ...
  social: [
    ...
    },
    {
      rank: 1,
      name: 'facebook',
      url: 'https://facebook.com/aclu.norcal',
    },
    {
      rank: 3,
      name: 'instagram',
