const data = {
  ...
  logo: {
    ...
    default: {
      size: '150',
      url: 'https://media.sailthru.com/64d/1k9/8/f/689f7757b2a2a.png'
    },
    eighty: {
      size: '200',
      url: ''
    ...
    newsletter: {
      size: '300',
      url: 'https://media.sailthru.com/64d/1k9/4/m/6807bc8245ab9.png'
    },
    ninety: {
      size: '200',
      url: ''
  ...
  privacy_url: 'https://www.aclu-wy.org/en/privacy-statement',
  signatures: {
    advo: {
      headshot: 'https://media.sailthru.com/64d/1k4/3/v/5e838bc7bf013.jpg',
  ...
  social: {
    bluesky: '',
    facebook_url: 'https://facebook.com/acluwyo',
    instagram_url: 'https://www.instagram.com/aclu_wyoming',
    threads_url: '',
    tiktok: '',
    x_url: 'https://x.com/ACLUWYO',
    youtube: ''
  },
